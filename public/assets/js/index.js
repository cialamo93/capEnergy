      ...
      function changeContentOnResize() {
        ...
        if (screenWidth <= 768) {
            ...
            secondCarousel.innerHTML = '<div class="video-container"> <video class="fullscreen-video" autoplay muted loop playsinline> <source src="assets/images/promoVid.mp4" type="video/mp4"> Tu navegador no soporta el tag de video. </video> <div class="overlay-text"> <h3 style="color: white" >Cap Energy</h3> <!-- <a href="#nextTrip" class="main-btn rounded-one">Saber Más</a> --> </div> </div>';
          }
        else {
          ...
          secondCarousel.innerHTML = '<div class="container"> <div class="row"> <div class="col-lg-6"> <div class="slider-content"> <h1 class="title">Cap Energy</h1> <!-- <ul class="slider-btn rounded-buttons"> <li><a class="main-btn rounded-one" href="#nextTrip">Saber Más</a></li> </ul> --> </div> </div> </div> </div>';
      }
    }
